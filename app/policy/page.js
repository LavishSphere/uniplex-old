...
const TermsPage = () => {
  return (
    <div>
      ...
      <h2>2. Eligibility</h2>
      <p>2.1. You must be at least 13 years old to use our Services. By using our Services, you represent and warrant that you are at least 13 years old. If you are under the age of 18, you must obtain parental consent to use our Services.</p>

      <h2>3. Minecraft Server Services</h2>
      <p>3.1. Uniplex provides Minecraft server services for entertainment purposes only. You agree to use the Minecraft server and associated features in compliance with our rules and guidelines, as provided on the Website or within the game.</p>
      <p>3.2. Uniplex reserves the right to suspend or terminate your access to the Minecraft server or any related Services at any time for violating these Terms or our rules and guidelines.</p>

      <h2>4. Payment and Billing</h2>
      <p>4.1. Uniplex accepts payments through PayPal, Credit Cards, Debit Cards, Bank transfers, and Cryptocurrencies. By making a payment, you authorize Uniplex to charge the specified amount to your selected payment method.</p>
      <p>4.2. All payments are non-refundable unless otherwise specified or required by applicable law.</p>
      ...
      <p>6.2. Minecraft is a registered trademark of Mojang AB. Uniplex is not affiliated with or endorsed by Mojang AB.</p>

      <h2>7. Limitation of Liability</h2>
      <p>7.1. To the maximum extent permitted by law, Uniplex and its affiliates shall not be liable for any direct, indirect, incidental, consequential, or exemplary damages arising from your use of our Website or Services, including but not limited to damages for loss of profits, data, or other intangible losses.</p>
